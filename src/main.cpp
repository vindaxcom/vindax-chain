...
const string strMessageMagic = "vindax Signed Message:\n";
...
// miner's coin base reward premine -- Premined:124.500.000
int64_t GetProofOfWorkReward(int64_t nFees)
{
        int64_t nSubsidy = 1 * COIN;
        
        if (pindexBest->nHeight+1 < 2)
            nSubsidy = 124500000 * COIN;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // vindax: check proof-of-stake block signature
...
// vindax: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vindax", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vindax.com Block";
        CTransaction txNew;
        txNew.nTime = 1554867000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1554867000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2470266;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2d13d9ce8c0c445d98473e213b7cac77c9744b861c4ddab10fd9950b4a92c65c"));
        block.print();
